...
Version 1.1 · 22 September 2026 · Planning, not a built game
...
The first sixteen tickets total **77–125 focused hours**, before a **20% reserve**. That is approximately **92–150 hours**. At fifteen hours a week, plan roughly seven to ten weeks. At ten hours a week, expect roughly ten to fifteen weeks. A beginner may need an additional learning block before these estimates become useful.
